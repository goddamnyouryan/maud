...
**Story:** `.maud/stories/index.md` — top backlog item ("Fix all the links in all of the markdowns. Make them consistent.")
...
**Goal:** `/maud:plan` deeply questions the user and produces `.maud/index.md`, the source of truth for what the project is.
...
2. Command writes `.maud/index.md` capturing the project's purpose, audience, and how it works
3. Output `.maud/index.md` is human-readable, matches the example in this repo's `.maud/index.md`, and the user agrees it accurately describes their project
...
**Success criteria:**
1. Command reads `.maud/index.md` and reasons about which planning subfolders fit the project (e.g., `competitors/`, `architecture/`, `technology/`, `design/` — or others)
...
**Goal:** Synthesize `.maud/index.md` + all `.maud/planning/<dimension>/` research into `.maud/planning/index.md` — "the plan" — ruthlessly scoped, no creep.
...
**Success criteria:**
1. `.maud/planning/index.md` exists and articulates the approach the project will take
...
**Goal:** Create `.maud/stories/` (with `index.md`, `backlog/`, `current/`, `complete/`) and populate the backlog from the plan, in an initial priority order the user can edit.
...
**Success criteria:**
1. `.maud/stories/` exists with `index.md`, `backlog/`, `current/`, `complete/` subdirectories
2. Backlog contains stories derived from `.maud/index.md`, `.maud/planning/index.md`, and any design — in a defensible initial order
3. `.maud/stories/index.md` lists all stories and serves as the project's "UI"; the user can re-prioritize by editing files directly
...
**Story:** `.maud/stories/backlog/build-command/index.md` (sub-task: "Takes the top story off of the backlog")

**Success criteria:**
1. Command identifies the top story in `.maud/stories/backlog/` (by file order in `index.md`)
2. The story file is moved into `.maud/stories/current/`
3. `.maud/stories/index.md` is updated to reflect the move; the change is committed to git
...
**Story:** `.maud/stories/backlog/build-command/index.md` (sub-task: "Asks the user questions about it if they have any")
...
**Story:** `.maud/stories/backlog/build-command/index.md` (sub-task: "Builds the story in Claude Code")
...
**Story:** `.maud/stories/backlog/build-command/index.md` (sub-task: "Have validation agents verify the work")
...
**Story:** `.maud/stories/backlog/build-command/index.md` (sub-task: "Presents it to the user for approval")
...
**Story:** `.maud/stories/backlog/build-command/index.md` (sub-task: "Once approved, merges into main, launches to production, if relevant.")
...
3. The story file moves from `.maud/stories/current/` to `.maud/stories/complete/`, `.maud/stories/index.md` is updated, and the changes are committed
